...
public class DocumentController {
    ...
    // Fixed: was @RequestBody — cannot receive multipart/form-data; must be @RequestParam
    @PostMapping(value = "/cloudinary/upload/{expenseId}", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<FileDocument> uploadCloudinaryImage(@PathVariable Long expenseId,
